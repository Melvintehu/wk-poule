...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 text-center padding-up-md">
                <h1 class="bold uppercase text-secondary font-md">Welke speler wordt top scoorder?</h1>
    ...
    <div class="container padding-sides-sm">
        <form action="/top-scorer" method="POST" >
            @csrf
            @method('post')
            <div class="row">
                ...
                <div class="col-xs-12 margin-up-sm ">
                    <div class="material-input">
                        <input name="topScorer" type="text" class="bg-none outline-none text-main font-md " required>
                        <i class="material-icons icon text-main">label</i>
                        <div class="bottom-bar"></div>
                        <label class="font-md text-main">Naam van de speler</label>
                    </div>
                </div>
