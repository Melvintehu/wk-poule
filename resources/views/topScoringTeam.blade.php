...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 text-center padding-up-md">
                <h1 class="bold uppercase text-secondary font-md">Welk team gaat het meest scoren?</h1>
    ...
    <div class="container padding-sides-sm">
        <form action="/topScoringTeam" method="POST" >
            @csrf
            @method('post')
            <div class="row">
                ...
                <div class="col-xs-12 margin-up-sm text-center">
                    {{--  <div class="material-input">
                        <input name="topScoringTeam" type="text" class="bg-none outline-none text-main font-md " required>
                        <i class="material-icons icon text-main">label</i>
                        <div class="bottom-bar"></div>
                        <label class="font-md text-main">Naam van het team</label>
                    </div>  --}}
                    <select class="border-none border-bottom border-secondary border-sm padding-sm paddings-sides-sm" name="topScoringTeam" >
